  ...
  theme: {
    extend: {
      colors: {
        ...
        // Material-3 palette used by the landing page, site footer and
        // license page. Static hex ON PURPOSE: these pages have their own
        // fixed light look independent of --ma-* app variables. Do not use
        // these tokens inside app features — prefer the CSS-variable set.
        primary: "#005c55",
